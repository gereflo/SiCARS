<?php
	...
	$consulta2 = "SELECT id_alumno FROM alumnos WHERE fase =".$fase." ORDER BY id_alumno" ;//Se consulta la tabla alumnos para saber cuantos alumnos hay
	//echo $consulta2;
	...
	elseif($orderby == 1 || $orderby == 2 || $orderby == 3 ||$orderby == 4 || $orderby == 5 || $orderby == 6 || $orderby == 7 || $orderby == 8){
		...
		$consultasumatoriatot = "SELECT SUM(valor) as total FROM registros JOIN alumnos ON alumnos_id_alumno = id_alumno WHERE estimulos_id_estimulo =".$orderby." AND fase =".$fase;
		//echo $consultasumatoriatot."<br>";
		$resultadosumatoriatot = mysqli_query( $conexion, $consultasumatoriatot ) or die ( "Algo ha ido mal en la consulta a la base de datos 3");
		$rows3 = $resultadosumatoriatot->fetch_assoc();
		$sumatoriatot = $rows3['total'];
		//echo $sumatoriatot."<br>";
		
		//$consultamenciones = "SELECT Count(palabras_id_palabra) as menciones from registros WHERE estimulos_id_estimulo = ".$orderby;
		$consultamenciones = "SELECT Count(palabras_id_palabra) as menciones from registros JOIN alumnos ON alumnos_id_alumno = id_alumno WHERE estimulos_id_estimulo =".$orderby." AND fase =".$fase;
...
<html lang="es">
	<head>
		<title>Gráficas de telaraña</title>
		<meta charset="utf-8">
	...
	<body>
		<div class="container">
			<div>
			<h1 class="display-4"><?php echo $_SESSION['alias'] ?>, En esta sección puedes ver la tabla y gráfica de RS</h1>
			<p class="lead">Aquí puedes seleccionar la manera en que se visualiza la información:</p>
				  ...
				  <div class="row">
					...
					<div class="btn-group" role="group">
							...
							<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
							  ...
							  <a class="dropdown-item" href="graficas_palabras.php?orderby=6">Hostigamiento Sexual</a>
					...
					<div class="btn-group" role="group">
							...
							<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
							  ...
							  <a class="dropdown-item" href="graficas_palabras.php?orderby=<?php echo $orderby."&perif=".$perif."&fase=0";?>">Investigación</a>
							  <a class="dropdown-item" href="graficas_palabras.php?orderby=<?php echo $orderby."&perif=".$perif."&fase=1";?>">Uno</a>
							  <a class="dropdown-item" href="graficas_palabras.php?orderby=<?php echo $orderby."&perif=".$perif."&fase=2";?>">Dos</a>
							  <a class="dropdown-item" href="graficas_palabras.php?orderby=<?php echo $orderby."&perif=".$perif."&fase=3";?>">Tres</a>
							  <a class="dropdown-item" href="graficas_palabras.php?orderby=<?php echo $orderby."&perif=".$perif."&fase=4";?>">General</a>
							</div>
						</div>
					</div>
				  </div>
					...
					<table class="table table-striped" id="myTable">
					  <thead>
						<tr>
						  ...
						  <th scope="col">Porcentaje mención</th>
						</tr>
					  </thead>
					  <tbody>
							<?php 
				...
				<br>
				<button id='saveButton'>Exportar a PNG</button>
				<div id="grafik">
...
<!-- D3 Code Start here -->
	...
	<script type="text/javascript">
		...
		var width = 1000;
		var height = 1000;
		var circulo_base_separacion = 45;
		...
		//Primero se dibujan las palabras y lineas dentro del ciculo de referencia						
        	...
        	var polygon = polygons
        					.attr("points", function(d) {
        										...
        										var grados_referencia_mas = grados+grados_para_aumentar/2;
        										var grados_referencia_menos = grados-grados_para_aumentar/2;
        										var cadena = "";
