...
<body>
	<form action="Formulario_resultado.php" method="post" name="f1" id="f1">
		...
		<div class="row">
			...
			<?php
				...
				while ($columna = mysqli_fetch_array( $resultado2 )){
					...
					for ($j = 5; $j >= 1; $j--) {
						...
						echo '</div>';
						echo '<input type="text" id="palabra'.$inputcount.'" name="palabra'.$inputcount.'" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" style="width:200px">';
			...
			?>
		<button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#exampleModalCenter" onclick="recibir();">Revisar</button>
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				<h5 class="modal-title" id="exampleModalLongTitle">Se va capturar un alumno con los siguientes datos:</h5>
