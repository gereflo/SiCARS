...
<?php
	...
	function resultadotest($suma){
		...
		if($suma == 45 || $suma>=34){
			return "Mucha semejanza <br><br>Explicación del resultado: ".$tex0;
		}
		else if($suma >  34 || $suma>=23){
			return "Considerable semejanza <br><br>Explicación del resultado: ".$tex1;
		}
		else if($suma > 23 || $suma>=11){
			return "Semejanza <br><br>Explicación del resultado: ".$tex2;
		}
		else if($suma > 11 || $suma>=1){
			return "Poca semejanza <br><br>Explicación del resultado: ".$tex3;
		}
		else if($suma > 1 || $suma==0){
			return "Nula semejanza<br><br>Explicación del resultado: ".$tex4;
		}
	}
	...
	function semejanza ($Pals, $jsonR){
		...
		echo "Suma total de puntos: ".$suma.". ";
...
<head>
	...
	<script LANGUAGE="JavaScript">
		...
		var pagina="http://repsocuamc.epizy.com/"
...
<body>
			<?php 
				$fase = 4; //Aqui se define en que fase prospectiva quedaran los alumnos almacenados
				...
				$idGenero = busquedagenero($conexion, $genero);
				
				$idAlumnoconsulta = "INSERT INTO alumnos (fecha, generos_id_genero, programas_id_programa, fase) 
					VALUES ('".$date."', '".$idGenero."', '13', '".$fase."')"; // establecer en 13 un programa generico.
				...
				foreach ($acosoPals as &$pal) {
					...
					if ($rb == 0 && $pal != false){
						...
						$rb = $rb["id_palabra"];
						//echo $rb;
						$insertRegistro = "INSERT INTO registros (valor, estimulos_id_estimulo, alumnos_id_alumno, palabras_id_palabra) VALUES ('".$j."', '5', '".$idalumno."', '".$rb."')"; //Acoso Sexual id=5
						//echo $insertRegistro;
				...
				foreach ($hostpals as &$pal) {
					...
					if ($rb == 0 && $pal != false){
						...
						$rb = $rb["id_palabra"];
						//echo $rb;
						$insertRegistro = "INSERT INTO registros (valor, estimulos_id_estimulo, alumnos_id_alumno, palabras_id_palabra) VALUES ('".$j."', '6', '".$idalumno."', '".$rb."')"; //Acoso Sexual id=6
						//echo $insertRegistro;
						$resultRegistro = mysqli_query( $conexion, $insertRegistro ) or die ( "Algo ha ido mal en la consulta a la base de datos58");
					}
					$j= $j-1;
				}
	...
	<p>Cómo leer la gráfica:<br>Rojo: conceptos nucleares con mayor preponderancia<br>
Amarillo: conceptos periféricos primer nivel mantienen relevancia<br>
Verde: conceptos periféricos segundo nivel poca relevancia, son contextualizadores<br>
<br>
Localizador <img src="images/mark.svg" alt="Azul" width="20">: la palabra que ingresaste no formaba parte del universo de palabras.<br>
Localizador <img src="images/mark2.svg" alt="Gris" width="20">: utilizaste una palabra que ya formaba parte de la representación social.<br>
</p>
