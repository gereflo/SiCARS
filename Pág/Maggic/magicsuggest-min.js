(function ($)
{
	...
	var MagicSuggest = function (element, options)
	{
		...
		var defaults = {
			...
			{
				return "Ya tienes " + v + " palabra escribe en el siguiente " + (v > 1 ? "s" : "")
			},
			method: "POST",
			minChars: 0,
			minCharsRenderer: function (v)
			{
				return "Por favor escribe " + v + " letra" + (v > 1 ? "s" : "") + " más"
			},
			mode: "local",
			name: null,
			noSuggestionText: "Ningúna sugerencia",
			placeholder: "Pulsa o da click aqui",
			renderer: null,
			required: false,
